...
namespace Clawssets.Builder
{
    ...
    public static class MapBuilder
    {
        ...
        private static void Write(this BinaryWriter writer, Claw.Tiled.Object obj)
        {
			...
			writer.Write(obj.point);
			writer.Write(obj.ellipse);
            ...
            writer.Write(obj.properties ?? new Property[] {});
			writer.Write(obj.polygon ?? new Vertice[] { });
		}
        ...
        /// <summary>
        /// Escreve os dados de uma propriedade num arquivo binário.
        /// </summary>
		...
		/// <summary>
		/// Escreve os dados de um array de vértices num arquivo binário.
		/// </summary>
		private static void Write(this BinaryWriter writer, Vertice[] vertices)
		{
			writer.Write(vertices.Length);

			for (int i = 0; i < vertices.Length; i++) writer.Write(vertices[i]);
		}
		/// <summary>
		/// Escreve os dados de um vértice num arquivo binário.
		/// </summary>
		private static void Write(this BinaryWriter writer, Vertice vertice)
		{
