...
namespace Clawssets.Builder
{
    ...
    public static class FontBuilder
    {
        ...
        public static void Build(AssetGroup group, string basePath)
        {
            ...
            for (int i = 0; i < group.Files.Count; i++)
            {
                ...
                else
                {
                    ...
                    Dictionary<char, SpriteFont.Glyph> glyphs = graphics.DrawFont(font, text, brush, description.Size, image.Size, out SizeF fontAtlasSize);
        ...
        /// </summary>
        private static void SaveFont(string path, string fontName, byte[] pixels, SizeF size, FontDescription description, Dictionary<char, SpriteFont.Glyph> glyphs)
        {
        ...
        /// <summary>
        /// Desenha a fonte no atlas e retorna um dicionário com os <see cref="SpriteFont.Glyph"/>s.
        /// </summary>
        private static Dictionary<char, SpriteFont.Glyph> DrawFont(this Graphics graphics, Font font, string characters, Brush brush, int emSize, Size imageSize, out SizeF measure)
        {
            PointF basePos = new PointF(AtlasBuilder.HorizontalOffset, 0);
            Dictionary<char, SpriteFont.Glyph> result = new Dictionary<char, SpriteFont.Glyph>();
            ...
            for (int i = 0; i < characters.Length; i++)
            {
                ...
                switch (glyphChar)
                {
                    ...
                    default:
                        ...
                        result.Add(glyphChar, new SpriteFont.Glyph(rect, glyphKerningPairs));
        ...
        /// </summary>
        private static void Write(this BinaryWriter writer, Dictionary<char, SpriteFont.Glyph> glyphs)
        {
            writer.Write(glyphs.Count);

            foreach (KeyValuePair<char, SpriteFont.Glyph> glyph in glyphs)
            {
