...
namespace Claw
{
    ...
    public struct Color
    {
        ...
        public string ToHex(HexFormat format = HexFormat.ARGB)
        {
            switch (format)
            {
                case HexFormat.RGBA: return ToHex(R, G, B, A); break;
                case HexFormat.ARGB: return ToHex(A, R, G, B); break;
                case HexFormat.BGRA: return ToHex(B, G, R, A); break;
                case HexFormat.ABGR: return ToHex(A, B, G, R); break;
            }
