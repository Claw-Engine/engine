...
namespace Claw
{
    ...
    public struct Rectangle
    {
        ...
        internal SDL.SDL_Rect ToSDL() => new SDL.SDL_Rect() { x = (int)X, y = (int)Y, w = (int)Width, h = (int)Height };
        internal SDL.SDL_FRect ToSDLF() => new SDL.SDL_FRect() { x = X, y = Y, w = Width, h = Height };
